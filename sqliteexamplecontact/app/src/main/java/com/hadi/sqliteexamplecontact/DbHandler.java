package com.hadi.sqliteexamplecontact;
...
public class DbHandler extends SQLiteOpenHelper {
    ...
    //The recommended approach/practice to using SQLite in an Android app is to create a
    // DatabaseHelper class whose only function is to provide the creation, modification,
    // and deletion of tables in the database upgrade the database version.
    @Override
