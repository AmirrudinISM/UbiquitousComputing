...
public class AppointmentForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(AppointmentForm.this,preferences.getString("uid",""),Toast.LENGTH_LONG).show();

        //get the spinner from the xml.
        locationSelect = findViewById(R.id.spinner);

        //create a list of items for the spinner.
        String[] vaccinationPoints = new String[]{"Ideal Convention Center, Shah Alam",
        ...
        //create a list of items for the spinner.
        String[] vaccinationTimes = new String[]{"09:00AM","10:00AM","11:00AM", "12:00PM", "03:00PM", "04:00PM"};
